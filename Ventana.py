...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableNfactura.setHorizontalHeaderItem(2, item)
        self.tableNfactura.horizontalHeader().setDefaultSectionSize(110)
        self.scrollArea_3.setWidget(self.scrollAreaWidgetContents_3)
        self.scrollArea_4 = QtWidgets.QScrollArea(self.tab_3)
        self.scrollArea_4.setGeometry(QtCore.QRect(380, 190, 611, 431))
        self.scrollArea_4.setWidgetResizable(True)
        self.scrollArea_4.setObjectName("scrollArea_4")
        self.scrollAreaWidgetContents_4 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 609, 429))
        ...
        self.tableArticulos.horizontalHeader().setDefaultSectionSize(120)
        ...
        self.lblSubtotal = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.lblSubtotal.setMinimumSize(QtCore.QSize(60, 20))
        self.lblSubtotal.setMaximumSize(QtCore.QSize(60, 20))
        self.lblSubtotal.setStyleSheet("background-color: rgb(229, 249, 255)")
        self.lblSubtotal.setInputMask("")
        self.lblSubtotal.setFrame(False)
        self.lblSubtotal.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.lblSubtotal.setReadOnly(True)
        self.lblSubtotal.setPlaceholderText("")
        self.lblSubtotal.setObjectName("lblSubtotal")
        self.horizontalLayout_14.addWidget(self.lblSubtotal)
        ...
        self.lblTotal = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.lblTotal.setMinimumSize(QtCore.QSize(60, 20))
        self.lblTotal.setMaximumSize(QtCore.QSize(60, 20))
        self.lblTotal.setStyleSheet("background-color: rgb(229, 249, 255)")
        self.lblTotal.setInputMask("")
        self.lblTotal.setFrame(False)
        self.lblTotal.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.lblTotal.setReadOnly(True)
        self.lblTotal.setPlaceholderText("")
        self.lblTotal.setObjectName("lblTotal")
        self.horizontalLayout_16.addWidget(self.lblTotal)
        ...
        self.lblIVA = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.lblIVA.setMinimumSize(QtCore.QSize(60, 20))
        self.lblIVA.setMaximumSize(QtCore.QSize(60, 20))
        self.lblIVA.setStyleSheet("background-color: rgb(229, 249, 255)")
        self.lblIVA.setInputMask("")
        self.lblIVA.setFrame(False)
        self.lblIVA.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.lblIVA.setReadOnly(True)
        self.lblIVA.setPlaceholderText("")
        self.lblIVA.setObjectName("lblIVA")
        self.horizontalLayout_13.addWidget(self.lblIVA)
        ...
        self.lblCodFact.setMinimumSize(QtCore.QSize(60, 20))
        self.lblCodFact.setMaximumSize(QtCore.QSize(16777215, 30))
        self.lblCodFact.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.lblCodFact.setStyleSheet("background-color: rgb(229, 249, 255)")
        self.lblCodFact.setText("")
        self.lblCodFact.setAlignment(QtCore.Qt.AlignCenter)
        self.lblCodFact.setObjectName("lblCodFact")
        self.horizontalLayout_10.addWidget(self.lblCodFact)
        ...
        self.editFechaFactura = QtWidgets.QLineEdit(self.layoutWidget5)
        self.editFechaFactura.setStyleSheet("background-color: rgb(229, 249, 255)")
        self.editFechaFactura.setAlignment(QtCore.Qt.AlignCenter)
        self.editFechaFactura.setObjectName("editFechaFactura")
        self.horizontalLayout_10.addWidget(self.editFechaFactura)
        self.btnCalendarFactura = QtWidgets.QPushButton(self.layoutWidget5)
        self.btnCalendarFactura.setAutoFillBackground(False)
        self.btnCalendarFactura.setStyleSheet("background-color: rgba(0,0,0,0)")
        self.btnCalendarFactura.setText("")
        self.btnCalendarFactura.setIcon(icon2)
        self.btnCalendarFactura.setIconSize(QtCore.QSize(50, 30))
        self.btnCalendarFactura.setObjectName("btnCalendarFactura")
        self.horizontalLayout_10.addWidget(self.btnCalendarFactura)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(20, 131, 961, 41))
        ...
        self.editApelido = QtWidgets.QLineEdit(self.layoutWidget6)
        self.editApelido.setStyleSheet("background-color: rgb(229, 249, 255)")
        self.editApelido.setObjectName("editApelido")
        self.horizontalLayout_11.addWidget(self.editApelido)
        ...
        self.btnNuevaVenta = QtWidgets.QPushButton(self.layoutWidget6)
        self.btnNuevaVenta.setMinimumSize(QtCore.QSize(30, 30))
        self.btnNuevaVenta.setMaximumSize(QtCore.QSize(30, 30))
        self.btnNuevaVenta.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/newPrefix/emblemdefault_93502.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnNuevaVenta.setIcon(icon3)
        self.btnNuevaVenta.setIconSize(QtCore.QSize(30, 30))
        self.btnNuevaVenta.setObjectName("btnNuevaVenta")
        self.horizontalLayout_11.addWidget(self.btnNuevaVenta)
        self.btneliminarVenta = QtWidgets.QPushButton(self.layoutWidget6)
        self.btneliminarVenta.setMinimumSize(QtCore.QSize(30, 30))
        self.btneliminarVenta.setMaximumSize(QtCore.QSize(30, 30))
        self.btneliminarVenta.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/newPrefix/1486395882-close_80604.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btneliminarVenta.setIcon(icon4)
        self.btneliminarVenta.setIconSize(QtCore.QSize(30, 30))
        self.btneliminarVenta.setObjectName("btneliminarVenta")
        self.horizontalLayout_11.addWidget(self.btneliminarVenta)
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(60, 130, 901, 41))
        self.layoutWidget7.setObjectName("layoutWidget7")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.layoutWidget7)
        self.horizontalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.lblNomeProd_2 = QtWidgets.QLabel(self.layoutWidget7)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.lblNomeProd_2.setFont(font)
        self.lblNomeProd_2.setObjectName("lblNomeProd_2")
        self.horizontalLayout_8.addWidget(self.lblNomeProd_2)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(400, 30, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.layoutWidget9.setGeometry(QtCore.QRect(60, 210, 901, 22))
        ...
        self.lblPrecioProd = QtWidgets.QLabel(self.layoutWidget9)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.horizontalLayout_12.addWidget(self.lblPrecioProd)
        self.editPrecioProd = QtWidgets.QLineEdit(self.layoutWidget9)
        self.editPrecioProd.setStyleSheet("background-color: rgb(229, 249, 255)")
        self.editPrecioProd.setObjectName("editPrecioProd")
        self.horizontalLayout_12.addWidget(self.editPrecioProd)
        ...
        self.lblStock = QtWidgets.QLabel(self.layoutWidget9)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.horizontalLayout_12.addWidget(self.lblStock)
        self.editStock = QtWidgets.QLineEdit(self.layoutWidget9)
        self.editStock.setStyleSheet("background-color: rgb(229, 249, 255)")
        self.editStock.setObjectName("editStock")
        self.horizontalLayout_12.addWidget(self.editStock)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/newPrefix/56805.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/newPrefix/62319.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/newPrefix/imprimir.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/newPrefix/databackup_theapplication_dedatos_3366.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionimprimir_2.setIcon(icon7)
        ...
        self.actionFacturas_Cliente = QtWidgets.QAction(MainWindow)
        ...
        self.menuBBDD.addAction(self.actionImportar_Datos)
        self.menuBBDD.addSeparator()
        self.menuBBDD.addAction(self.actionRestaurar)
        self.menuBBDD.addAction(self.actionBackup)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "DNI"))
        item = self.tableNfactura.horizontalHeaderItem(2)
        ...
        self.lblNomeProd_2.setText(_translate("MainWindow", "Codigo:  "))
        ...
        self.actionFacturas_Cliente.setText(_translate("MainWindow", "Facturas Cliente"))
